...
export default function CardPortifolio({imageUrl, description, redirectUrl}: CardProps) {
    return (
        <a href={redirectUrl} target="_blank" className="flex max-w-[330px] flex-col items-center cursor-pointer hover:transform hover:-translate-y-2 transition-all duration-300 group">
